# islandsContract - AI Agent Instructions
...
Implement the islands metadata contract utilities according to SPEC.typ while ensuring all test cases in implementation.test.ts pass.
