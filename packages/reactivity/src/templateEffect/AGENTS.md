# templateEffect API - AI Agent Instructions
...
Implement the templateEffect API according to SPEC.typ while ensuring all test cases in implementation.test.ts pass.
