# defineAtomStoreSnapshot API - AI Agent Instructions
...
Implement the snapshot schema API according to SPEC.typ while ensuring all test cases in implementation.test.ts pass.
